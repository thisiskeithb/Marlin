...
#define NO_AUTO_ASSIGN_WARNING // silence "Auto-assigned ... *_PINS" warning
...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb, Grumpy 32-bit/SKR 1.4/TMC2209)" // Original author or contributor.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    // Creality Ender-3 w/ Genuine E3D V6 w/ copper block and 450C thermistor from Slice Engineering
