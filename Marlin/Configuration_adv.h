 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT UP_DOWN_CURRENT  // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  X_CURRENT  // (mA) RMS current for sensorless homing
    #define X_MICROSTEPS UP_DOWN_MICROSTEPS // 0..256
    ...
    #define Y_CURRENT UP_DOWN_CURRENT
    #define Y_CURRENT_HOME  Y_CURRENT
    #define Y_MICROSTEPS UP_DOWN_MICROSTEPS
    ...
    #define I_CURRENT NOZZLE_ROTATION_CURRENT
    #define I_CURRENT_HOME I_CURRENT
    #define I_MICROSTEPS NOZZLE_ROTATION_MICROSTEPS
    ...
    #define J_CURRENT NOZZLE_ROTATION_CURRENT
    #define J_CURRENT_HOME J_CURRENT
    #define J_MICROSTEPS NOZZLE_ROTATION_MICROSTEPS
